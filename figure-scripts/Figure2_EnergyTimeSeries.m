...
p1 = plot(t1/wvd1.tscale,Z1/wvd1.zscale,LineWidth=2); hold on
p2 = plot(t9/wvd1.tscale,Z9/wvd1.zscale,LineWidth=2);
p3 = plot(t18/wvd1.tscale,Z18/wvd1.zscale,LineWidth=2);

set(gca,'ColorOrderIndex',1)
plot(t1_2x/wvd1.tscale,Z1_2x/wvd1.zscale,LineWidth=2), hold on
plot(t9_2x/wvd1.tscale,Z9_2x/wvd1.zscale,LineWidth=2)
plot(t18_2x/wvd1.tscale,Z18_2x/wvd1.zscale,LineWidth=2)
...
p4 = plot([1 1]*t1_2x(1)/wvd1.tscale,ylim,LineWidth=1,Color=0*[1 1 1],LineStyle="--");
p5 = plot([1 1]*3050,ylim,LineWidth=1,Color=0*[1 1 1]);
